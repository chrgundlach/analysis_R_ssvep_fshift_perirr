...
dat2plot_all %>%
  ...
  mutate(
    ...
    t_test_bf = map(data, ~ extractBF(ttestBF(formula = RT_Mean ~ colorlum, data = ., iterations = num.iter, rscale = 1))),
    meanval = map(data, ~ .x %>%
                    group_by(colorlum) %>%
                    summarise(
...
dat2plot_all %>%
  ...
  mutate(
    ...
    t_test_bf = map(data, ~ extractBF(ttestBF(formula = Hitrate ~ colorlum, data = ., iterations = num.iter, rscale = 1))),
    meanval = map(data, ~ .x %>%
                    group_by(colorlum) %>%
                    summarise(
...
dat2plot_all %>%
  ...
  mutate(
    ...
    t_test_bf = map(data, ~ extractBF(ttestBF(formula = FA_proper_rate ~ colorlum, data = ., iterations = num.iter, rscale = 1))),
    meanval = map(data, ~ .x %>%
                    group_by(colorlum) %>%
                    summarise(
...
dat2plot_all %>%
  ...
  mutate(
    ...
    t_test_bf = map(data, ~ extractBF(ttestBF(formula = d_prime ~ colorlum, data = ., iterations = num.iter, rscale = 1))),
    meanval = map(data, ~ .x %>%
                    group_by(colorlum) %>%
                    summarise(
...
dat2plot_all %>%
  ...
  mutate(
    ...
    t_test_bf = map(data, ~ extractBF(ttestBF(formula = c ~ colorlum, data = ., iterations = num.iter, rscale = 1))),
    meanval = map(data, ~ .x %>%
                    group_by(colorlum) %>%
                    summarise(
