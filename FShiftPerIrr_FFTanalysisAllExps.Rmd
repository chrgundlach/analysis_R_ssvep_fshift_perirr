...
#!!!!!!! relevant
# broad cluster | larger central cluster as in Tango study | peri both clusters
# CSD based normalized to pre-cue baseline in %
# for changed experiment starting with participant 22: isoluminant stimuli and lower flicker frequencies
#  
DATAPath = "data_in/FFT_Amp_data_TangoStudy_11-21-2024_13-53.csv"
t_baseline = c(-1000, 0)

# broad cluster | larger central cluster as in Tango study | peri only center
# DATAPath = "data_in/FFT_Amp_data_TangoStudyPeriOnlyCenter_10-16-2024_11-08.csv"
# t_baseline = c(-1000, 0)

# # broad cluster | larger central cluster as in Tango study | peri only lateral
# DATAPath = "data_in/FFT_Amp_data_TangoStudyPeriOnlyLateral_10-16-2024_11-08.csv"
# t_baseline = c(-1000, 0)
...
# smaller cluster | smaller central cluster two elecs | peri only center
# CSD based normalized to pre-cue baseline in %
# for changed experiment starting with participant 22: isoluminant stimuli and lower flicker frequencies
#  
# DATAPath = "data_in/FFT_Amp_data_smallclust_allsubs_09-04-2024_14-56.csv"
# t_baseline = c(-1000, 0)

# smaller cluster | smaller central cluster four elecs | peri only center
# CSD based normalized to pre-cue baseline in %
# for changed experiment starting with participant 22: isoluminant stimuli and lower flicker frequencies
#  
# DATAPath = "data_in/FFT_Amp_data_smallclust_allsubs_09-06-2024_15-08.csv"
# t_baseline = c(-1000, 0)
...
dat2plot %>%
  ...
  mutate(
    t_test_bf = map(data, ~{extractBF(ttestBF(x = .$subtraction_evoked, data = .,iterations=num.iter,rscale=1))})
  )%>%
